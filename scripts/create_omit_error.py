...
def introduce_errors(file_path):
    ...
    for i in range(24, len(original_text), 25):  # Change 19 and 20 for every 20 characters
        if i < len(modified_text):
            random_index = random.randint(i - 24, i)
            # Replace with a random Arabic character from the given list
            modified_text[random_index] = " "
...
if __name__ == "__main__":
    ...
    folder_path = '/home/ocr_project/twenty_five_char_omit_error'
